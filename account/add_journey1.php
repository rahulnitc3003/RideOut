  ...
  <div class="container">
    ...
    <form class="form-horizontal" method="POST" action="add_journey.php">
      ...
      <div class="form-group">
        ...
        <div class="col-sm-6">
          <input type="text" class="form-control" id="carno" style="width:10" name="carno" required pattern="^[A-Za-z]{2}([ \-])[0-9]{2}[A-ZAa-z0-9]{1,2}[A-Za-z]\1[0-9]{4}$" placeholder="Enter Car Number [ Format {XX-00XX-0000} ]">
        </div>
      </div>
      ...
      <div class="form-group">
        ...
        <div class="col-sm-6">
          <input type="text" class="form-control" id="src" name="src" required placeholder="Enter Source Location">
        </div>
      </div>
      ...
      <div class="form-group">
        ...
        <div class="col-sm-6">
          <input type="text" class="form-control" id="dest" name="dest" required placeholder="Enter Destination Location">
        </div>
      </div>
      ...
      <div class="form-group">
        ...
        <div class="col-sm-6"> 
          <input type='text' class="form-control" name="seat" required placeholder="Enter Seats Number ( upto 5 seats )" pattern="[1-5]{1}" />
        </div>
      </div>
...
if(isset($_POST['submit']))
{
  ...
  $mobno=$_POST['mobno'];
      ...
      if($dateofjour <= $date1)
      {
        echo "<script>alert('Current Or Previous Date Can't Be Entered')</script>";
        exit(0);
      }
      if($seats == 0)
      {
