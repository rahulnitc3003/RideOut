  ...
  <div class="container">
	...
	<div class="col-sm-12">
		...
		<table class="table" border="5">	
			...
			<tr>
				<td>Source</td>
				<td><input type="text" class="form-control" id="src" name="src" required placeholder="Enter Source"></td>
			</tr>
			<tr>
				<td>Destination</td>
				<td><input type="text" class="form-control" id="dest" name="dest" required placeholder="Enter Destination"></td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td><input type="text" class="form-control" id="dest" name="seatsbook" required placeholder="Enter Required Seats[ 1 to 5 ]" pattern="[1-5]" /></td>
			</tr>
			<tr>
